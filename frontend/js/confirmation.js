...
numCde.innerHTML = ` <p class="text-center text-4xl font-weight-bold mb-4 fs-2">Merci ${
  order.contact.firstName
}. Votre commande a bien été prise en compte ! En espérant vous revoir très bientôt</p>
